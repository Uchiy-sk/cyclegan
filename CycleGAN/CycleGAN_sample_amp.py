...
holo_horses = holo_horses[:num]
holo_zebras = holo_zebras[:num]
...
# image -> holo
for i in tqdm(range(holo_horses.shape[0])):
    holo_horses[i, :, :, 0] = asm(                       # holo -> [0, 1]
        holo_horses[i, :, :, 0], z, lam)[0] * 2 - 1      # holo -> [-1, 1]
    holo_horses[i, :, :, 1] = asm(                       # holo -> [0, 1]
        holo_horses[i, :, :, 0], z, lam)[2] * 2 - 1      # holo -> [-1, 1]
    holo_horses[i, :, :, 2] = 0
    # print('.', end="")
print('')

for i in tqdm(range(holo_zebras.shape[0])):
    holo_zebras[i, :, :, 0] = asm(
        holo_zebras[i, :, :, 0], z, lam)[0] * 2 - 1
    holo_zebras[i, :, :, 1] = asm(
        holo_zebras[i, :, :, 0], z, lam)[2] * 2 - 1
    holo_zebras[i, :, :, 2] = 0
    # print('.', end="")
print('')
...
def generate_images(model, test_input, num):
    filename = f"C:\\Users\\uchiyama\\OneDrive - 千葉大学\\ドキュメント\\Python\\research\\picture\\sample\\amp_phase\\cyclegan_epoch_{num}.jpg"
    # filename = f"C:\\Users\\Uchiy\\OneDrive - 千葉大学\\ドキュメント\\Python\\research\\picture\\sample\\amp_phase\\cyclegan_epoch_{num}.jpg"
...
plt.savefig("C:\\Users\\uchiyama\\OneDrive - 千葉大学\\ドキュメント\\Python\\research\\picture\\sample\\amp_phase\\cyclegan_gen.png")
# plt.savefig("C:\\Users\\Uchiy\\OneDrive - 千葉大学\\ドキュメント\\Python\\research\\picture\\sample\\amp_phase\\cyclegan_gen.png")
...
plt.savefig("C:\\Users\\uchiyama\\OneDrive - 千葉大学\\ドキュメント\\Python\\research\\picture\\sample\\amp_phase\\cyclegan_disc.png")
# plt.savefig("C:\\Users\\Uchiy\\OneDrive - 千葉大学\\ドキュメント\\Python\\research\\picture\\sample\\amp_phase\\cyclegan_disc.png")
...
plt.savefig("C:\\Users\\uchiyama\\OneDrive - 千葉大学\\ドキュメント\\Python\\research\\picture\\sample\\amp_phase\\cyclegan_fid.png")
# plt.savefig("C:\\Users\\Uchiy\\OneDrive - 千葉大学\\ドキュメント\\Python\\research\\picture\\sample\\amp_phase\\cyclegan_fid.png")