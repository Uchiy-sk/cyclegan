...
train_horses = tf.data.Dataset.from_tensor_slices(num_train)
train_zebras = tf.data.Dataset.from_tensor_slices(h_train)
test_horses = tf.data.Dataset.from_tensor_slices(num_test)
test_zebras = tf.data.Dataset.from_tensor_slices(h_test)
...
# plt.imshow(sample_zebra[0])
# plt.show()

# print(sample_zebra[0])
...
def generate_images(model, test_input, num):
    ...
    # filename = f"C:\\Users\\uchiyama\\OneDrive - 千葉大学\\ドキュメント\\Python\\research\\picture\\cyclegan_holo\\z=0.02(1000)\\holo_epoch_{num+1}.jpg"
    filename = f"C:\\Users\\Uchiy\\OneDrive - 千葉大学\\ドキュメント\\Python\\research\\picture\\cyclegan_holo\\z=0.02(1000)\\holo_epoch_{num+1}.jpg"
...
for inp in test_horses.take(1):
    generate_images(generator_g, inp, -2)

for inp in test_zebras.take(1):
    generate_images(generator_f, inp, -3)
...
# plt.savefig("C:\\Users\\uchiyama\\OneDrive - 千葉大学\\ドキュメント\\Python\\research\\picture\\cyclegan_holo\\z=0.02(1000)\\gen_loss.png")
plt.savefig("C:\\Users\\Uchiy\\OneDrive - 千葉大学\\ドキュメント\\Python\\research\\picture\\cyclegan_holo\\z=0.02(1000)\\gen_loss.png")
...
# plt.savefig("C:\\Users\\uchiyama\\OneDrive - 千葉大学\\ドキュメント\\Python\\research\\picture\\cyclegan_holo\\z=0.02(1000)\\disc_loss.png")
plt.savefig("C:\\Users\\Uchiy\\OneDrive - 千葉大学\\ドキュメント\\Python\\research\\picture\\cyclegan_holo\\z=0.02(1000)\\disc_loss.png")
