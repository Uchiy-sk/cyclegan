...
for i in tqdm(range(num)):
    for j in range(3):
        train_svhn[i, :, :, j] = trans_holo.asm(
            train_svhn[i, :, :, j], z, lam)[0]
...
for i in tqdm(range(num)):
    for j in range(3):
        train_mnist[i, :, :, j] = trans_holo.asm(
            train_mnist[i, :, :, j], z, lam)[j]
...
# Check points
checkpoint_path = "./checkpoints/svhn2mnist_holo"
...
# plt.imshow(np.stack(train_svhn)[0, :, :, 0] * 0.5 + 0.5)
# plt.show()

# plt.imshow(np.stack(train_mnist)[0, :, :, 0] * 0.5 + 0.5)
# plt.show()


# 要素を順番に取り出す next(iter
sample_svhn = next(iter(train_svhn))
...
def generate_images(model, test_input, num):
    ...
    # filename = f"C:\\Users\\uchiyama\\OneDrive - 千葉大学\\ドキュメント\\Python\\research\\picture\\svhn2mnist_holo\\epoch_{num+1}.jpg"
    filename = f"C:\\Users\\Uchiy\\OneDrive - 千葉大学\\ドキュメント\\Python\\research\\picture\\svhn2mnist_holo\\epoch_{num+1}.jpg"
...
for epoch in range(EPOCHS):
    ...
    generate_images(generator_g, sample_svhn, epoch)
    ...
    fid = culc_fid.get_fid(real, fake)
    print("FID : ", fid)
...
# plt.savefig("C:\\Users\\uchiyama\\OneDrive - 千葉大学\\ドキュメント\\Python\\research\\picture\\svhn2mnist_holo\\gen_loss.png")
plt.savefig(
    "C:\\Users\\Uchiy\\OneDrive - 千葉大学\\ドキュメント\\Python\\research\\picture\\svhn2mnist_holo\\gen_loss.png")
...
# plt.savefig("C:\\Users\\uchiyama\\OneDrive - 千葉大学\\ドキュメント\\Python\\research\\picture\\svhn2mnist_holo\\disc_loss.png")
plt.savefig(
    "C:\\Users\\Uchiy\\OneDrive - 千葉大学\\ドキュメント\\Python\\research\\picture\\svhn2mnist_holo\\disc_loss.png")
...
# plt.savefig("C:\\Users\\uchiyama\\OneDrive - 千葉大学\\ドキュメント\\Python\\research\\picture\\svhn2mnist_holo\\fid.png")
plt.savefig(
    "C:\\Users\\Uchiy\\OneDrive - 千葉大学\\ドキュメント\\Python\\research\\picture\\svhn2mnist_holo\\fid.png")
